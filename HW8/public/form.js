...
app.controller('formControl', function($scope, $http, $timeout, $q, $log) {
    ...
    var init = function(){
        ...
        $scope.data = { keyword:'', category:'all', selected:'here', distance:'', zipcodeInput:'' };
    ...
    $scope.detail = function(data, tab, move){
        ...
        $scope.shareLink.result = "https://www.facebook.com/dialog/share?app_id=2180637285326079&display=popup&href=" + data.itemURL + "&quote=" + encodeURI("Buy " + data.title + " at $" + data.price + " from link below");
    }
